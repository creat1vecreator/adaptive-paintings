  ...
  return (
    <div className={styles.pagination__wrapper} data-theme={theme}>
      <ul className="pagination">
        <button
          className="pagination__backTotal"
          disabled={currentPage === 1 || !totalButtons.length}
          onClick={backPageTotal}
        >
        ...
        <button className="pagination__back" disabled={currentPage === 1 || !totalButtons.length} onClick={backPage}>
        ...
        {totalButtons.map((num) => (
          <button
            className={`pagination__page-item ${currentPage === num ? styles.current : ''}`}
            key={`key-${num}`}
            value={num}
        ...
        <button
          className="pagination__ahead"
          disabled={currentPage === totalButtons[totalButtons.length - 1]}
          onClick={aheadPage}
        >
          <svg width="9" height="13" viewBox="0 0 9 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
